...
%         phase_v0_upper;
    ...
    methods
        ...
        function str = showGridParam(self, index)
            str = sprintf('p ratio is %s', num2str(self.omega_p_ratios(index)));
            disp(str);
        end
...
%                     self.phase_lower_threshold
                ...
                if cur_upper < self.phase_upper_threshold 
                    ...
                    self.terminate_phase(self.phase_lower, self.cur_omega_pi2_estimate);
                    break;
                end
                ...
                if Q > self.cur_omega_pi2_estimate
                    fprintf('gap enlarging to %s \n', num2str(self.cur_omega_pi2_estimate *2) );
